...
urlpatterns = [
    ...
    path('my-cart-api', views.MyCartAPIView.as_view(), name = 'category-list'),
    path('my-cart-api/<int:pk>/', views.MyCartRetrieveUpdateDestroyAPIView.as_view(), name = 'category-list'),
]
